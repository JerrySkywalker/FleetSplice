...
export function GatewayDashboard({ request, ready }: { request: (url: string) => Promise<any>; ready: boolean }) {
  ...
  return <section className="gateway-dashboard" aria-label="Fleet Gateway Dashboard">
    ...
    {section === 'Devices' && <p className="gateway-panel">No enrolled device projection is available yet.</p>}

...
export const enUS = {
  permission: 'Permission', READ_ONLY: 'Read only', WORKSPACE_AUTO: 'Workspace Auto', YOLO: 'YOLO', requestedPermission: 'Requested permission', effectivePermission: 'Native effective permission', permissionUnavailable: 'Unavailable', permissionHint: 'New sessions only. Edge enforces the local Host ceiling. YOLO means native unrestricted filesystem and network authority, not permission to leave your task scope.',
  ...
  pageTitle: 'FleetSplice · Local session', edition: 'LOCAL / G05C-P2B', preferences: 'Preferences',
  language: 'Language', appearance: 'Appearance', localeChinese: '简体中文', localeEnglish: 'English',
  system: 'System', light: 'Light', dark: 'Dark', oledBlack: 'OLED Black',
  midnight: 'Midnight', graphite: 'Graphite', warm: 'Warm', close: 'Close',
  ...
  onThisMachine: 'On this machine', nativeReadOnly: 'Native Codex · Local coding',
  ...
  promptPlaceholder: 'Ask a question about your work…', readOnlyHint: 'Native coding · Check the session effective permission before sending',
  ...
  newSessionConfigurationHint: 'Model, reasoning and permission selection apply only when starting a new native session. Existing sessions keep their recorded configuration.',
  ...
  footer: 'Local loop · FleetSplice 0.1 / G05C-P2B',
...
export const zhCN = {
  permission: '权限', READ_ONLY: '只读', WORKSPACE_AUTO: '工作区自动', YOLO: 'YOLO', requestedPermission: '请求权限', effectivePermission: '原生有效权限', permissionUnavailable: '不可用', permissionHint: '仅用于新会话。Edge 强制执行本地主机上限。YOLO 表示原生文件系统与网络权限不受沙箱限制，不代表可以超出任务范围。',
  newWorkspaceTarget: '新会话的工作区', sessionWorkspace: '当前会话工作区', workspaceIdentity: '根目录身份', workspaceInvalid: '不可用或已替换',
  newSessionConfigurationHint: '模型、推理和权限选择仅用于启动新的原生会话。已有会话保持其记录的配置。',
  pageTitle: 'FleetSplice · 本地会话', edition: '本地 / G05C-P2B', preferences: '偏好设置',
  language: '语言', appearance: '外观', localeChinese: '简体中文', localeEnglish: 'English',
  system: '跟随系统', light: '浅色', dark: '深色', oledBlack: 'OLED 黑',
  midnight: '午夜蓝', graphite: '石墨灰', warm: '暖纸色', close: '关闭',
  ...
  onThisMachine: '在此设备上', nativeReadOnly: '原生 Codex · 本地编程',
  ...
  promptPlaceholder: '输入你的问题…', readOnlyHint: '原生编程 · 发送前请确认当前会话的有效权限',
  ...
  footer: '本地链路 · FleetSplice 0.1 / G05C-P2B',

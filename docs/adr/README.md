...
| --- | --- | --- |
| [ADR-0001](0001-hub-edge-command-and-failure-boundary.md) | Fleet-scoped AuthorityAnchor lineage, Hub/Edge authority, FleetCommand/EdgeCommand, reconnect, and ambiguity | Proposed |
...
| [ADR-0006](0006-security-provenance-and-self-iteration.md) | AuthorityAnchor trust separation, security, donor provenance, trusted kernel, and stable-N self-iteration | Proposed |

...
export interface NativePort {
  ...
  start(): Promise<void>;
  create(requestId: string, root: string): Promise<{ threadId: string; model: string; provider: string }>;
  turn(requestId: string, threadId: string, root: string, text: string): Promise<string>;
...
export class CodexDriver implements NativePort {
  ...
  private rpc(id: string, method: string, params: unknown): Promise<any> {
